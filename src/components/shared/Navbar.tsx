...
const Navbar = () => {
  ...
  return (
    <>
      {/* Overlay - moved outside header and covers everything */}
      <div
        className={`fixed inset-0 bg-lightGreen/50 backdrop-blur-sm transition-opacity duration-300 md:hidden ${
          openMobileMenu ? "opacity-100 z-40" : "opacity-0 pointer-events-none"
        }`}
        onClick={() => setOpenMobileMenu(false)}
      />
      
      <header className="md:h-24 h-16 w-full flex items-center justify-between shadow relative z-50 bg-white">
        <div className="container mx-auto px-4 md:px-0 max-w-screen-xl flex items-center justify-between relative z-50 bg-white">
